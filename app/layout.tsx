...
export const metadata: Metadata = {
  ...
  description:
    "Accounts Receivable and Sales Ledger Specialist with 6+ years across billing, collections, credit control, payment application, and reconciliation, including Accenture's Microsoft account. Based in the Philippines.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "6+ years of accuracy-driven Accounts Receivable, Sales Ledger, Billing, Collections, and Reconciliation experience across enterprise finance operations.",
  ...
  twitter: {
    ...
    title: "Katrina Paula Inajenes | Accounts Receivable & Reconciliation Specialist",
    description:
      "6+ years of accuracy-driven Accounts Receivable, Sales Ledger, Billing, Collections, and Reconciliation experience.",
    images: ["/og-image.jpg"],
  },
